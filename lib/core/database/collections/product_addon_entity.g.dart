...
void _productAddonEntitySerialize(
  ...
  writer.writeBool(offsets[2], object.isPerUnit);
...
ProductAddonEntity _productAddonEntityDeserialize(
  ...
  object.isPerUnit = reader.readBool(offsets[2]);
...
extension ProductAddonEntityByIndex on IsarCollection<ProductAddonEntity> {
  Future<ProductAddonEntity?> getBySyncId(String? syncId) {
    return getByIndex(r'syncId', [syncId]);
  }

  ProductAddonEntity? getBySyncIdSync(String? syncId) {
  ...
  Future<List<ProductAddonEntity?>> getAllBySyncId(List<String?> syncIdValues) {
    final values = syncIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'syncId', values);
  }

  List<ProductAddonEntity?> getAllBySyncIdSync(List<String?> syncIdValues) {
    final values = syncIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putBySyncId(ProductAddonEntity object) {
    return putByIndex(r'syncId', object);
  }

  Id putBySyncIdSync(ProductAddonEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'syncId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllBySyncId(List<ProductAddonEntity> objects) {
    return putAllByIndex(r'syncId', objects);
  }

  List<Id> putAllBySyncIdSync(List<ProductAddonEntity> objects,
      {bool saveLinks = true}) {
...
extension ProductAddonEntityQueryProperty
  ...
  QueryBuilder<ProductAddonEntity, bool, QQueryOperations> isDeletedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductAddonEntity, String?, QQueryOperations> syncIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'syncId');
    });
  }

  QueryBuilder<ProductAddonEntity, DateTime?, QQueryOperations>
      updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
