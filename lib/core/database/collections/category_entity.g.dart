...
extension CategoryEntityQuerySortBy
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QAfterSortBy> sortByIsActive() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryEntityQuerySortThenBy
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QAfterSortBy> thenByIsActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActive', Sort.asc);
    });
  }
...
extension CategoryEntityQueryWhereDistinct
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QDistinct> distinctByIsActive() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryEntityQueryProperty
  ...
  QueryBuilder<CategoryEntity, bool, QQueryOperations> isActiveProperty() {
    return QueryBuilder.apply(this, (query) {
